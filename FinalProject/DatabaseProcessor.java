...
public class DatabaseProcessor {
    ...
    /**
     * insertScore takes a score object as an argument and inserts the values held
     * within into the
     * database of scores to be stored long term. it uses the database javasql
     * drivers
     *
     * @param currentScore
     */
    public void insertScore(Score currentScore) {
        ...
        try {
            ...
            String sql = "INSERT INTO SCORES (Name, Score, Time)" +
                    "VALUES ('" + currentScore.getName() + "'," + currentScore.getScore() + ",'"
    ...
    public ArrayList<Score> GenerateWinners() {
        ...
        try {
            ...
            while (set.next()) {
                // if there is another record in the database then it will copy into temp
                // variables before building and adding an object

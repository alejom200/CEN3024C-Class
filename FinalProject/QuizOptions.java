...
public class QuizOptions {
    ...
    // this entire function is still kind of a mess but it works at the moment so im
    // not going to try and make it cleaner till
    ...
    public boolean compareItem(Object p) {
        ...
        // this is kinda a mess but im not really sure how else to fix it aside from
        // possibly an arraylist but that would add 9 more lines of code to the project
        // and make it a bit clunkier
        if (tempAnswer1.equals(p) || tempAnswer2.equals(p) || tempAnswer3.equals(p) || tempAnswer4.equals(p)
                || tempAnswer5.equals(p) || tempAnswer6.equals(p) || tempAnswer7.equals(p) || tempAnswer8.equals(p)
                || tempAnswer9.equals(p)) {
            return true;
        }

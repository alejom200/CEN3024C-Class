...
public class DatabaseCreation {
    ...
    public static void createTables() {
        ...
        try {
            ...
            // this line fills the connection object with a connection to the database
            // handled by driveManager.getConnection
            conn = DriverManager.getConnection(url);
            System.out.println("successfully called database!");

            // this fills the statement object with a specific method to create statements
            // from the connection
            ...
            // this line prints the error class, name and then message to better track the
            // error
